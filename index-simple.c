...
//	fgcol = 97;
	...
	if(posX>20 && posX < 29 && posY > 9 && posY < 12)
		color = 43; //YELLO
	if(posY>2 && posY<19){
		if((color==DEFBG)&&posX>21&&(posY<10 || posY>11)){
...
void indexBox(int ofs, int ofx, int q){ //{{{
	...
	sprinter(ofx,ofs+ 4, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+ 5, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+ 6, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+ 7, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+ 8, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+ 9, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+10, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+11, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+12, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+13, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+14, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+15, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+16, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+17, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+18, colIns, colBox, "│   $ curl she-a.eu/test    │");
	sprinter(ofx,ofs+19, colIns, colBox, "└┐  $ curl sh_             ┌┘");
	sprinter(ofx+1,ofs+20,colIns,colBox,  "└─────────────────────────┘");
	sprinter(ofx+19,ofs+0,table, colBox,                 " ┌───┐");
	sprinter(ofx+19,ofs+1,table, colBox,                 "┌┘   └──┐");
	sprinter(ofx+14,ofs+ 2,table, colBox,           "─────┘ cURLs └┐");
	for(int i=0; i<16; i++){
		sprinter(ofx+4, ofs+4+i, colIns, 32, "$");
		sprinter(ofx+6, ofs+4+i, colIns, 94, "curl");}
	for(int i=0; i<15; i++)
		sprinter(ofx+11, ofs+4+i, colIns, 93, "she-a.eu");
	if(q==1){
		sprinter(ofx+19, ofs+4, colIns, 95, "       ");
		sprinter(ofx+19, ofs+5, colIns, 95, "/index");
		sprinter(ofx+19, ofs+6, colIns, 95, "/about");}
	else{
		sprinter(ofx+19, ofs+4, colIns, 95, "/simple");

		sprinter(ofx+1, ofs+5, colIns, 32, "$");
		sprinter(ofx+3, ofs+5, colIns, 94, "curl ");
		sprinter(ofx+8, ofs+5, colIns, 93, "she-a.eu");
		sprinter(ofx+16,ofs+5, colIns, 95, "/index/simpl");

		sprinter(ofx+1, ofs+6, colIns, 32, "$");
		sprinter(ofx+3, ofs+6, colIns, 94, "curl ");
		sprinter(ofx+8, ofs+6, colIns, 93, "she-a.eu");
		sprinter(ofx+16,ofs+6, colIns, 95, "/about/simpl");
	}
	sprinter(ofx+11, ofs+19,colIns, 93, "sh\e[5m_");
